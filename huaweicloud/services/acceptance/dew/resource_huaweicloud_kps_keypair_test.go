		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "type", "ssh"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "name", rName),
					resource.TestCheckResourceAttr(resourceName, "type", "ssh"),
					resource.TestCheckResourceAttr(resourceName, "scope", "domain"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "created_at"),
					resource.TestCheckResourceAttrSet(resourceName, "fingerprint"),
					resource.TestCheckResourceAttrPair(resourceName, "encryption_kms_key_name",
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"encryption_type", "encryption_kms_key_name"},
			},
		},
	})
}
...
resource "huaweicloud_kps_keypair" "test" {
  ...
  scope                   = "domain"
  encryption_type         = "kms"
  encryption_kms_key_name = huaweicloud_kms_key.test.key_alias
}
`, rName, rName)
}
